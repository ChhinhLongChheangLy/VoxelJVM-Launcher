package com.voxeljvm.launcher.plugins;
...
public class FFmpegPlugin {
    ...
    public static void discover(Context context) {
        ...
        try {
            PackageInfo ffmpegPluginInfo = manager.getPackageInfo("com.voxeljvm.launcher.ffmpeg", PackageManager.GET_SHARED_LIBRARY_FILES);
