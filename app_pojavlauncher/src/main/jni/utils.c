...
JNIEXPORT void JNICALL Java_com_voxeljvm_launcher_utils_JREUtils_setupBridgeSurfaceAWT(JNIEnv *env, jclass clazz, jlong surface) {
...
JNIEXPORT void JNICALL Java_com_voxeljvm_launcher_utils_JREUtils_setLdLibraryPath(JNIEnv *env, jclass clazz, jstring ldLibraryPath) {
...
JNIEXPORT jboolean JNICALL Java_com_voxeljvm_launcher_utils_JREUtils_dlopen(JNIEnv *env, jclass clazz, jstring name) {
...
JNIEXPORT jint JNICALL Java_com_voxeljvm_launcher_utils_JREUtils_chdir(JNIEnv *env, jclass clazz, jstring nameStr) {
...
JNIEXPORT jint JNICALL Java_com_voxeljvm_launcher_utils_JREUtils_executeBinary(JNIEnv *env, jclass clazz, jobjectArray cmdArgs) {
	jclass exception_cls = (*env)->FindClass(env, "java/lang/UnsatisfiedLinkError");
